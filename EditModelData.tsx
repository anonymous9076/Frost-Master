const productFields = [
    ...
    },
    {
      ...
      "label": "Material",
      "type": "select",
      "options": ["Stainless Steel", "Plastic", "Wood", "Glass", "Silicone", "Ceramic", "Other"],
      "className":
        "w-full p-2 border rounded-lg border-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-400"
    },
    {
    ...
    },
    {
      ...
      "previewItemClassName": "w-full flex items-center border border-gray-300 rounded-md py-2 px-3  gap-2 justify-between",
      "buttonClassName": "flex items-center gap-1",
      "wrapperClassName": "text-blue-400 border py-[2rem] border-blue-400 rounded-lg w-full flex items-center relative justify-center ",
