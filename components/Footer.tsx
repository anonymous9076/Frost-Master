...
const Footer = () => {
  ...
  return (
    <div className='olive w-full h-fit min-h-[2rem] pt-[3rem] pb-[1rem] px-[2rem] cursor-pointer'>
      <div className='flex w-full gap-5 pb-[3rem] justify-evenly md:flex-row flex-col'>
        <div className='px-[2rem] w-full'>
          ...
          <ul className='flex flex-col py-[1rem]'>
            ...
            <li className='flex items-center gap-4 mt-[2rem]'>
              <span className='text-[30px]'><FaInstagram></FaInstagram></span>
              <span className='text-[25px]'><FaFacebookF></FaFacebookF></span>
              <span className='text-[30px]'><FaYoutube></FaYoutube></span>
              <span className='text-[30px]'><FaLinkedinIn></FaLinkedinIn></span>
            </li>
          </ul>
        </div>
        <div className='px-[2rem] w-full'>
