            ...
            {products
              ? products.splice(0,7).map((item, index) => (
                  <ul
                    ...
                    key={index}
                  >
                    <li className="w-[24%] whitespace-nowrap overflow-hidden">{item.name}</li>
                    <li className="w-[20%] whitespace-nowrap overflow-hidden">{item.category}</li>
                    <li className="w-[15%] flex h-full gap-1 items-center">{item.price}</li>
                    <li className="w-[18%]">
