...
const ShowUsers = () => {
  ...
  return (
    <div className="h-screen  w-full flex bg-gray-100">
      {deleteModel?<DeleteModel handleCloseModel={handleCloseModel} category={'User'}></DeleteModel>:''}
      <Sidebar></Sidebar>
      <div className="flex-1 h-full text-gray-700 ">
        ...
        <div className="px-[4rem] w-full bg-gray-100 min-w-[900px] overflow-x-auto  h-[92%] py-[2rem] text-[14px] ">
          ...
          <span className="w-full flex  items-start flex-col ">
              Search
              <input type="search" placeholder="Search by Dser ID, Name, Email" className="bg-gray-100 py-1 px-2 w-full border-2 border-gray-200 rounded-md  ">
