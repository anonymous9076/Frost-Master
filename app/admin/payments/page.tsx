        ...
        <div className="px-[4rem] w-full bg-gray-100 min-w-[900px] overflow-x-auto  h-[92%] py-[2rem] text-[14px] ">
          <div className="bg-white h-[5rem] w-full rounded-lg px-[1.5rem] flex items-center gap-3">
            <span className="w-full flex  items-start flex-col ">
              Search
              <input type="search" placeholder="Search by Transaction ID or Order ID" className="bg-gray-100 py-1 px-2 w-full border-2 border-gray-200 rounded-md  ">
               
              </input>
            </span>
            <span className="flex items-start flex-col ">
              Date
              <input type="date" className="bg-gray-100 py-1 px-2 w-[160px] border-2 border-gray-200 rounded-md  ">
            ...
            {orders
              ? orders.splice(0,7).map((item, index) => (
                  ...
                  >
                    ...
                    <li className="w-[17%] flex h-full gap-1 items-center">{item.paymentMethod}</li>
                    <li className="w-[15%]">
                ...
                item.status
                    ...
                    <li className="w-[8%] flex items-center gap-3">
                      ...
                      <span className="text-[16px] text-blue-400" title="reload"><IoReload></IoReload></span>
                    </li>
                  </ul>
                ))
              : ""}
