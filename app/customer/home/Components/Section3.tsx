...
const Section3 = () => {
  return (
    <div className="bg-[#EAEAEA] w-full flex lg:flex-row flex-col py-[5rem] px-[4rem]">
      <div className="w-full lg:w-[50%] text-gray-600 ">
        <h2 className="text-gray-900 text-[30px] font-semibold">
          Why frostmaster.in?
        </h2>
        <p className="text-[17px] w-[90%]">
      ...
      <div className="relative w-[50%] hidden lg:block">
        ...
        <span className="absolute olive top-[20%] left-[70%] rounded-full h-[150px] w-[150px] flex items-center justify-center  text-[18px] text-center">
          Cumulative<br></br> 100+ Years <br></br> Experience
        </span>
        <span className="absolute olive top-[60%] left-[40%] rounded-full h-[200px] w-[200px] flex items-center justify-center text-[18px] text-center">
          4500+ Commercial <br></br> Kitchen <br></br>Equipments{" "}
        </span>
        <span className="olive absolute top-[40%] left-[40%] rounded-full h-[60px] w-[60px]">
          {" "}
        </span>
        <span className="olive absolute top-[65%] left-[35%] rounded-full h-[40px] w-[40px]">
          {" "}
        </span>
        <span className="olive absolute top-[65%] right-[0%] rounded-full h-[40px] w-[40px]">
          {" "}
        </span>
      </div>
    </div>
