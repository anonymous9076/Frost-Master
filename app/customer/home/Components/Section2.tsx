        ...
        <div className="w-[100%]  overflow-hidden xl:w-[60%] grid grid-cols-2 gap-6  p-[5%]">
          {img.map((item, index) => (
            ...
            >
              <div
                key={index}
                className=" hover:shadow-md hover:scale-105 transition-transform !duration-500  w-[100%]  h-[150px] md:h-[200px] relative bg-blue-400 rounded-2xl overflow-hidden"
              >
                <Image
                  src={item.image}
                  alt=""
                ...
                />
                <span className="absolute bottom-2 text-[20px] left-3 text-white">
                  {" "}
                  {item.text}
                </span>
              </div>
