...
const img = [
  {
    ...
    image:"/Images/PremiumKitchenEquipments/img4.jpg"
  },
  {
    ...
    image:"/Images/PremiumKitchenEquipments/img14.jpg"
  ...
  },
  {
    ...
    image:"/Images/PremiumKitchenEquipments/img24.jpg"
  ...
  },
  {
    ...
    image:"/Images/PremiumKitchenEquipments/img34.jpg"
...
const Section2 = () => {
  ...
  return (
    <div  className="w-full light pb-[3rem]">
      ...
      <div data-aos="fade-up" className="w-[90%] h-fit rounded-2xl flex lg:flex-row flex-col border-y border-r border-[#35736E] ">
