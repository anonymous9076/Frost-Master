...
const page = () => {
  ...
  return (
    <CustomerLayout>
      <Navbar></Navbar>
      <div className="h-[100dvh] pt-[10dvh] relative flex items-center w-full olive">
        ...
        <div className="flex-1 h-full  flex items-center justify-center flex-col">
          <p className=" leading-15 w-[75%] text-left text-[25px] font-bold">
            WELCOME TO <br></br>
            FORST MASTER PVT.LTD
          </p>
          <p className=" w-[70%] text-left text- text-[20px]">
