...
const Section2 = () => {
  ...
  return (
    <div className="light w-full h-fit py-[4rem]">
      ...
      <div key={index} className="w-[350px] h-[75dvh] p-4 bg-white border border-gray-200 rounded-lg shadow-sm ">
        <a href="#">
          <Image
