...
const Section2 = () => {
  const items = [
    { title: "Innovative Solution", anime:'fade-up', desc: "We will defy the conventional processes and explore the possibilities. We will constantly break our paradigms by entering into the unknown. We will constantly research, formulate and deliver innovative solutions", 
    ...
    { title: "Relationship for Life",anime:'fade-up', desc: "Once you fill in your details, you’re added to the right student group (e.g., MBA, Computer Science). Engage in meaningful academic discussions, exchange resources, and get the support you need.", 
