...
const TermAndConditions = () => {
  ...
  const handleFilterPost=(e:any)=>{
    const value =e.target.value.toLowerCase()
    const filter = termsData.filter((item)=> value== item.category.toLowerCase())
    ...
    <>
      ...
      <div className="h-fit min-h-screen w-full light py-[2rem]">
        <div className="h-[4rem]  w-[70%] mx-auto mb-[2rem]  flex items-center justify-between text-[#35736E] text-[30px] font-bold">
          ...
          <select className="text-[18px] font-normal border rounded-md px-3 py-2" onChange={(e)=>handleFilterPost(e)}>
        ...
        <div className="w-[70%] gap-8  h-fit grid grid-cols-2 place-items-center items-center justify-evenly mx-auto">
         ...
         <div key={index} className="w-full  bg-white border border-gray-200 rounded-lg shadow-sm ">
         <Image
         ...
         <div className="p-5">
           <span className="flex gap-2 py-4 text-[#35736E]">
             <p>21 January 2025</p>
             <p className="border-l-2 border-[#35736E] px-3">{item.category}</p>
           </span>
